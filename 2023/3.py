...
### I confused myself with min and max bounds and had to spend a lot of time debugging
### The approach is probably not the most elegant, but it gets part 1 done