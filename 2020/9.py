...
def part_two(input, preamble_length):
...
if __name__ == "__main__":
    ...
    print(f"Part 1 Test: {part_one(test_input, 5)[0]} (expected {P1TEST})")
    print(f"Part 2 Test: {part_two(test_input, 5)} (expected {P2TEST})")
    print()
